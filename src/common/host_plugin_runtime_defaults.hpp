...
inline constexpr int kDefaultHostPluginRequestTimeoutMs = kDefaultHostPluginRenderTimeoutSeconds * 1000;
inline constexpr int kDefaultHostPluginPrepareTimeoutMs = kDefaultHostPluginPrepareTimeoutSeconds * 1000;
