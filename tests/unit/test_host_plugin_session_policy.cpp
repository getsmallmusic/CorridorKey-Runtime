...
TEST_CASE("host plugin session policy canonicalizes artifact names",
          "[unit][ofx][runtime][regression]") {
    CHECK(app::detail::canonical_host_plugin_artifact_name(
              "models/corridorkey_fp16_1536_ctx.onnx") == "corridorkey_fp16_1536_ctx.onnx");
