...
try {
    ...
    foreach ($issPath in @($onlineIssPath, $offlineIssPath)) {
        ...
        foreach ($requiredToken in @(
            ...
            "#define InstallerWizardImage `"",
            "#define InstallerWizardSmallImage `"",
            "[Setup]",
            "AppId={{7C93E726-017B-45ED-931B-78436F7612A8}",
            "AppPublisher=CorridorKey",
            "UninstallDisplayIcon={#SharedRuntimeRoot}\Contents\Win64\corridorkey.exe",
            ...
            "Name: `"gui`"; Description: `"CorridorKey GUI`"",
            ...
            "Name: `"desktopicon`"; Description: `"Create a CorridorKey GUI desktop shortcut`"; GroupDescription: `"Shortcuts:`"; Components: gui; Flags: unchecked",
            "[Icons]",
            "Name: `"{autoprograms}\CorridorKey\CorridorKey GUI`"; Filename: `"{#SuiteGuiRoot}\CorridorKey.exe`"; WorkingDir: `"{#SuiteGuiRoot}`"; Components: gui",
            "Name: `"{autodesktop}\CorridorKey GUI`"; Filename: `"{#SuiteGuiRoot}\CorridorKey.exe`"; WorkingDir: `"{#SuiteGuiRoot}`"; Components: gui; Tasks: desktopicon",
            "[Dirs]",
            ...
            "Filename: `"{#SuiteInventoryPath}`"; Section: `"model_files`"; Key: `"corridorkey_fp16_512.onnx`"; String: `"green-models`"; Components: green",
            "Filename: `"{#SuiteInventoryPath}`"; Section: `"compiled_context_models`"; Key: `"corridorkey_fp16_512_ctx.onnx`"; String: `"green-models`"; Components: green",
            "Filename: `"{#SuiteInventoryPath}`"; Section: `"model_files`"; Key: `"corridorkey_dynamic_blue_fp16.ts`"; String: `"blue-models`"; Components: blue",
